...
var ProposalListComponent = (function () {
    function ProposalListComponent() {
        ...
        this.proposalTwo = new proposal_1.Proposal(99, 'Cool Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
        this.proposalThree = new proposal_1.Proposal(300, 'Bank Company', 'http://portfolio.jordanhudgens.com', 'Ruby on Rails', 150, 120, 15, 'jordan@devcamp.com');
        this.proposals = [
            this.proposalOne,
            this.proposalTwo,
            this.proposalThree
